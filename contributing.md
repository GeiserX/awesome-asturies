...
- El proyecto debe **dar soporte específico al Principado de Asturias** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
- El proyecto debe estar **mantenido activamente** (actividad en los últimos 3 años) y no estar archivado.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución asturiana** a la que el software da soporte (p.ej. asturias.es, uniovi.es, sadei.es). Esto ayuda a verificar que el proyecto es relevante para el Principado de Asturias.
