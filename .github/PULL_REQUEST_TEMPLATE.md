...
## Proyecto(s) añadido(s)

<!--
Para cada proyecto añadido, indica:
- URL del repositorio
- URL del servicio/API/institución asturiana a la que da soporte (p.ej. asturias.es, uniovi.es, sadei.es)
Elimina esta sección si no aplica.
-->

| Proyecto | Servicio/Institución asturiana |
|----------|-------------------------------|
...
- URL del repositorio
- Motivo (archivado, no funcional, reemplazado, no específico de Asturias, etc.)
Elimina esta sección si no aplica.
-->
